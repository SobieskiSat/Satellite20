...
void loop()
{
  ...
  SerialUSB.println(String((int)readString[0]) + " " + String((int)readString[1]));

  packetLen = 2;
  sendBuffer[0] = (uint8_t)readString[0];
  sendBuffer[1] = (uint8_t)readString[1];
